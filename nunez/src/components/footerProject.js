  ...
  return (
    <div className="footer">
      ...
      <div className="footer-group">
        ...
        <p>
          Comprometemo-nos a proteger a sua privacidade<br/> e garantir a segurança
          dos seus dados.
        </p>
      </div>
      <div className="footer-group">
        <h2>Termos de Uso</h2>
        <p>
          Os serviços oferecidos estão sujeitos aos<br/> nossos termos e condições.
          <br/>Consulte-nos para mais detalhes.
        </p>
      </div>
      <div className="footer-group">
